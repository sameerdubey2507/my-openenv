...
# 1. Use a patched, stable base
FROM python:3.11-slim-bookworm

# 2. Security updates for OS packages
...
# 3. Fix Python tool vulnerabilities
...
# 6. Set non-root user (Judges love this for security)
RUN useradd -m emergi
USER emergi
